package greenecomall.finance.outbox;

import greenecomall.finance.domain.OutboxMessage;
import greenecomall.finance.repo.OutboxRepository;
...
/** Досылает неотправленные строки outbox в Kafka по времени создания; ошибка одной не блокирует прочие. */
@Component
public class OutboxRelay {
    ...
    @Scheduled(fixedDelayString = "${finance.outbox-poll-interval:2s}")
    @Transactional
    public void flush() {
