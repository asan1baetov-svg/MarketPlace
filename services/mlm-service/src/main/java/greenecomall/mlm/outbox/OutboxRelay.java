package greenecomall.mlm.outbox;

import greenecomall.mlm.domain.OutboxMessage;
import greenecomall.mlm.repo.OutboxRepository;
...
public class OutboxRelay {
    ...
    @Scheduled(fixedDelayString = "${mlm.outbox-poll-interval:2s}")
    @Transactional
    public void flush() {
