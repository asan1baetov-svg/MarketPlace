package greenecomall.courier.outbox;

import greenecomall.courier.domain.OutboxMessage;
import greenecomall.courier.repo.OutboxRepository;
...
public class OutboxRelay {
    ...
    @Scheduled(fixedDelayString = "${courier.outbox-poll-interval:2s}")
    @Transactional
    public void flush() {
